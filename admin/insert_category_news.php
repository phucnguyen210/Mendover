...
if (isset($_POST['insert_category_news'])) {
    ...
    header('Location:insert_category_news.php');
}
?>
...
<form action="" method="post" class="mb-2">
    <div class="input-group w-90 mb-2">
        ...
        <input type="text" class="form-control" name="news_title" placeholder="Insert News" aria-label="News"
