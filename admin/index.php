...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-item-center">
                ...
                <div class="button text-center">
                    <button><a href="index.php?insert_category_products" class="nav-link text-light bg-info my-1">Insert
                            Category product</a></button>
                    <button><a href="index.php?insert_products" class="nav-link text-light bg-info my-1">Insert
                            Products</a></button>
                    <button><a href="index.php?insert_category_news" class="nav-link text-light bg-info my-1">Insert
                            category News</a></button>
                    <button><a href="index.php?insert_news_product" class="nav-link text-light bg-info my-1">Insert
                            News products</a></button>
                    <!-- <button><a href="" class="nav-link text-light bg-info my-1">View categories</a></button> -->
                    <!-- <button><a href="index.php?insert_news_products.php" class="nav-link text-light bg-info my-1">Insert
                            category new -->
                    </a></button>
                    <!-- <button><a href="" class="nav-link text-light bg-info my-1">INsert NEWS Products</a></button>
                    <button><a href="" class="nav-link text-light bg-info my-1">All orders</a></button>
                    <button><a href="" class="nav-link text-light bg-info my-1">All payments</a></button> -->
                    <button><a href="list_user.php" class="nav-link text-light bg-info my-1">List User</a></button>
        ...
        <div class="container my-3">
            ...
            if (isset($_GET['insert_category_news'])) {
                include('insert_category_news.php');
            }
